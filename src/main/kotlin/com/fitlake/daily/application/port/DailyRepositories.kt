...
interface DailyCaptureRepository {
	...
	fun findByIdAndUserId(captureId: DailyCaptureId, userId: UserId): DailyCapture?
	fun findByIdAndUserIdForUpdate(captureId: DailyCaptureId, userId: UserId): DailyCapture?
